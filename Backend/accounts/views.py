...
from rest_framework.exceptions import  MethodNotAllowed  , NotAuthenticated , AuthenticationFailed , APIException
...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid( raise_exception= True):  # other way to handle error during validation (one is in register view)        
