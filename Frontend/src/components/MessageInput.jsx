...
export default function inputInput({ onSendMessage }) {
  ...
  return (<div className='w-full bg-gray-950 border-t-[0.5px] border-gray-800  flex justify-center items-center h-[5rem]  px-4 lg:h-[6rem]'>
    <form className="relative w-full bg-gray-800 rounded-3xl flex items-center focus-within:ring-1 focus-within:ring-purple py-2 px-3 max-w-[48rem] mx-auto">
      ...
      <input
        ...
        className="w-full px-2 text-lg bg-transparent text-gray-100 focus:outline-none caret-purple"
