          ...
          onSubmit(formData)
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            <p className="">
                              {formType === 'login' ? (
                                <>Don't have an account? <span className="text-blue-500 cursor-pointer hover:underline underline-offset-1" onClick={() => navigate('/auth/register')}>Create one</span></>
                              ) : (
                                <>Already have an account? <span className="text-blue-500 cursor-pointer hover:underline underline-offset-1" onClick={() => navigate('/auth/login')}>Login</span></>
                              )}
                            </p>
                        </div>
                    </div>
